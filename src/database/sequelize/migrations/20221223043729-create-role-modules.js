...
const { ATTR_TABLE, ATTR_INT_ROLE, ATTR_INT_MODULE, ATTR_INT_CREATED_BY, ATTR_INT_UPDATED_BY, ATTR_DATETIME_CREATED_AT, ATTR_DATETIME_UPDATED_AT, ATTR_INT_ID } = require('../tableColumns/system/rolemodules')
